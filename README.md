...
| 로딩 | 타이틀 |
|:---:|:---:|
| ![CatPang — 로딩 화면](docs/images/title_loading.png) | ![CatPang — 타이틀(시작)](docs/images/title_first.png) |
...
- **장애물과 보스가 길을 막는다.** 벽·포탈·고양이 상자·물고기·공·생성기 등 매치만으로는 못 깨는 블록이 목표를 지키고, 10스테이지마다 등장하는 보스가 벽 소환·블록 생성으로 방해합니다.
...
| **보스** | 100 | 보스 HP + 스킬 방해 | 10스테이지마다 벽/생성기/고양이상자 패턴 |
